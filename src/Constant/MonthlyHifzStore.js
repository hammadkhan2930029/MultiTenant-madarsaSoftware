...
export const getMonthlyJaizaEntries = () => readEntries();

export const getMonthlyJaizaEntryById = (id) =>
  readEntries().find((entry) => entry.id === id);

export const saveMonthlyJaizaEntry = (entry) => {
...
export const subscribeToMonthlyJaizaEntries = (callback) => {
  if (!canUseStorage) return () => {};
